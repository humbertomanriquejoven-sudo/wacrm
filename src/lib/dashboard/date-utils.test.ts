...
describe("mondayIndex", () => {
  it("maps Monday → 0 and Sunday → 6", () => {
    // Build dates from local components so the weekday is correct in any
    // timezone (a bare "YYYY-MM-DD" string parses as UTC midnight and can
    // land on the previous day in the Americas).
